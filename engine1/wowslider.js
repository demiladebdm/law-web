...
(function() {
    var a;
    window.ws_caption_move = function(j, h, d, f) {
        var c = jQuery;
        var g = [{
            left1: "100%",
            top2: "100%"
        ...
        var b = 0.5;
        var e = "easeOutElastic1";
        var i = j.noDelay ? 0 : (j.duration / 2 - j.captionDuration / 3);
        if (i < 0) {
            i = 0
        }
        h.stop(1, 1).delay(i).fadeOut(j.captionDuration / 3);
        if (f) {
            if (a) {
                clearTimeout(a)
            }
            a = setTimeout(function() {
                ...
                for (var n in g) {
                    if (/\%/.test(g[n])) {
                        g[n] = parseInt(g[n]) / 100;
                        var o = h.offset()[/left/.test(n) ? "left" : "top"];
                        var l = /left/.test(n) ? "width" : "height";
                        if (g[n] < 0) {
                            g[n] *= o
                        } else {
                            g[n] *= j.$this[l]() - h[l]() - o
                ...
                function k(p) {
                    ...
                    c(m[p]).css({
                        ...
                        opacity: q
                    }, j.captionDuration, "easeOutCirc").animate({
                        top: 0,
                        left: 0
                    }, {
                        duration: j.captionDuration,
                        easing: (g.easing || e),
                        queue: false
                    })
                }
                ...
                setTimeout(function() {
                    k(1)
                }, j.captionDuration * (g.distance || b))
            }, j.noDelay ? 0 : (j.duration / 2 + i))
        }
    }
}());
